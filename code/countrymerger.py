...
MIXED_STANDARDS = {
    'en_mixed' : {
        'master' : 'STATE_en_UN',
        'slaves' : ['STATE_en_WorldBank', 'STATE_en_alternative', 'gdelt_state']
    }, 
    'ru_mixed' : {
        'master' : 'STATE_ru',
        'slaves' : ['STATE_ru_alt']
...
key_columns = ['STATE_ru', 'STATE_ru_alt','STATE_en_UN', 'STATE_en_WorldBank', 
                   'STATE_en_alternative', 'STATE_en_alternative_2','STATE_en_alternative_3',
